...
const UploadFormationDocumentation: React.FC = () => {
  const dispatch = useDispatch();
  const tabKey = "borrowerInfo";
  const subTabKey = "currentFormationDoc";
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6 md:p-12">
      ...
      <Typography variant="h5" className="font-heading text-gray-800 mb-4">
        Upload Formation Documentation
      </Typography>
      <Typography variant="body1" className="text-gray-600 mb-6">
        Please upload your client’s entity formation documents.
      </Typography>
...
export default UploadFormationDocumentation;
