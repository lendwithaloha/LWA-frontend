...
import { Box, Tabs, Tab, Typography, Button, FormControl, FormControlLabel, FormLabel, IconButton, InputAdornment, MenuItem, Radio, RadioGroup, Select, Switch, TextField, Tooltip } from "@mui/material";
...
import Vacant from "../components/brrr/Vacant";
import LeaseForm from "../components/brrr/leased";
                ...
                {currentTab === 0 && (
                    <Box>
                        ...
                        <div className="w-2/3 flex flex-col gap-5">
                            ...
                            <TabInput label="Tax Amount" description="Enter the total monthly/annual property tax amount for the property." />
                                <TabInput label="Insurance Amount" description="Enter the total monthly/annual property insurance premium amount for the property." />
                                <div>
                                    <Typography variant="subtitle1" mb={2}>
