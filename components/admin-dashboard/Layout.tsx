  ...
  return (
    <AppContent>
      <div className="flex h-screen">
        {/* Sidebar */}
        <div
          className={`fixed top-0 left-0 h-full bg-white shadow-md z-40 transform ${isOpen ? "translate-x-0" : "-translate-x-full"
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Main Content */}
          <main className="p-8 flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
            {children}
          </main>
